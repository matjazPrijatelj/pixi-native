...
test("portable manifest pins the selected local native archive", () => {
    const manifest = createPortablePackageManifest({
        ...
        facadeArchiveName: "matjash-pixi-native-0.2.4.tgz",
        nativeArchiveName: "matjash-pixi-native-linux-x64-0.2.4.tgz",
        pixiVersion: "8.21.0",
    ...
    assert.equal(
        ...
        "file:vendor/matjash-pixi-native-linux-x64-0.2.4.tgz",
    );
