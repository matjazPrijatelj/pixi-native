...
Scenes are selected with `1`–`5`: Graphics, Sprite, Text, BitmapText, and Video. Use the left and right arrow keys to move between scenes. Key-repeat events are ignored.
