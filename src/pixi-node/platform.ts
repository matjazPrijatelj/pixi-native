...
export function getDefaultGpuBackend(platform: NodeJS.Platform): NativeGpuBackend {
...
/** The current native video bridge is built around Linux FFmpeg VA-API. */
export function supportsNativeVideo(platform: NodeJS.Platform = process.platform): boolean {
