...
export class FpsOverlay7 extends Container {
    ...
    public constructor() {
        ...
        background.beginFill(0x101522, 0.85).drawRoundedRect(0, 0, 360, 32, 6).endFill();
    ...
    public tick(deltaMS: number): void {
        ...
        const variance = Math.max(0, this.squaredElapsedMS / this.frameCount - averageFrameMS ** 2);
