...
function parseExtraArgs(value: string | undefined): string[] {
    ...
    if (!Array.isArray(parsed) || parsed.some((entry) => typeof entry !== "string")) {
        throw new Error("RTP_TEST_EXTRA_INPUT_ARGS_JSON must be a JSON string array");
    }
    return parsed;
}

export function loadRtpTestConfig(environment: NodeJS.ProcessEnv = process.env): RtpTestConfig | null {
    ...
    return {
        ...
        height: positiveNumber(environment.RTP_TEST_HEIGHT, 1080, "RTP_TEST_HEIGHT"),
