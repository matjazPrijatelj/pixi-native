...
import { NodeDOMAdapter, normalizeRefreshRate } from "../pixi-native/NodeDOMAdapter.ts";
...
export async function createWebGlRenderer(options: NodeRendererOptions = {}): Promise<{ app: Application; native: NodeRendererContext }> {
